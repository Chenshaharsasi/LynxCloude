...
אני עובד בסטודיו לינקס באשקלון — כושר פונקציונלי / CrossFit / הרמת כושר. הסגנון הוויזואלי שאני מכוון אליו (כברירת מחדל, אלא אם reference מורה אחרת):

- **סגנון**: photographic, dynamic, energetic. לא flat-illustration ולא 3D-render אלא אם מבקשים מפורש.
- **קומפוזיציה**: focus על תנועה, מאמץ, אסתטיקה של כוח. אנשים בפעולה — לא דוממים.
- **תאורה**: טבעית או נטורליסטית; mood של אימון אמיתי, לא סטריאוטיפ פיטנס מצולם.
- **פלטה**: warm tones (תאורת זהב / אורנג'), עם accents נוטרליים (אפור / שחור). להימנע מ-neon.
- **קהל**: ישראלי מעורב — להציג גוון מציאותי, כולל מתאמנים בכל גיל ורמה.
- **אסור**: ערימת ציוד מלאכותי "stock-fitness" אסתטי-יתר; טקסט מוטבע על התמונה (זה תפקיד יעל ב-MD/HTML).
